...
class GraphModel(models.Model):
    ...
    def __str__(self):
        return (
            ...
            f"Sray Temp: {self.sray_temp}, DL SLN Temp: {self.dl_sln_temp}, "
            f"Ref Temp: {self.ref_temp}, U Tube Temp: {self.u_tube_temp}, "
            f"Ovrflw Lgt Temp: {self.ovrflw_lgt_temp}, HTG Top Temp: {self.htg_top_temp}, "
            ...
            f"Ref Temp Low HYS: {self.ref_temp_low_hys}, HTG HR Hi SP: {self.htg_hr_hi_sp}, "
